...
},{"core-js/fn/regexp/escape":5,"core-js/shim":298,"regenerator-runtime/runtime":2}],2:[function(require,module,exports){
...
},{"_process":307}],3:[function(require,module,exports){
...
},{"global/document":300,"hyperx":303,"on-load":306}],4:[function(require,module,exports){
...
},{"min-document":4}],301:[function(require,module,exports){
(function (global){
...
},{"./update-events.js":311,"bel":3,"morphdom":305}],311:[function(require,module,exports){
module.exports = [
...
$(document).ready(function () {
  ...
  if (container.length == 1) {
    ...
    container.vegas({
      delay: 11000,
      overlay: true,
      slides: [{ src: "../../img/background/img1.png" }, { src: "../../img/background/img2.png" }, { src: "../../img/background/img3.png" }, { src: "../../img/background/img4.jpg" }]
    });
  }
});

},{"vegas":309}],313:[function(require,module,exports){
"use strict";
...
$(document).ready(function () {
    ...
    if (!(0, _isNull2.default)(element)) {

        _events2.default.addEventAction(element, "click", function () {

            var form = (0, _template2.default)();

            var formContainer = document.getElementById('container-form');

            (0, _emptyElement2.default)(formContainer).appendChild(form);

            new _taggle2.default('tags', {
            ...
            _events2.default.addEventAction(document.getElementById("bm-save"), "click", function () {
...
$(document).ready(function () {
  ...
  document.getElementById("add-folder").addEventListener("click", function () {
    ...
    var form = (0, _yoYo2.default)(_templateObject);
...
},{"empty-element":299,"yo-yo":310}],315:[function(require,module,exports){
"use strict";
...
var _templateObject = _taggedTemplateLiteral(["\n            <div>\n                <div class=\"alert alert-success hide\">\n                    Bookmark guardado!!!\n                </div>\n                <div class=\"alert alert-warning hide\">\n                Problemas al guardar el Bookmark :(\n                </div>\n                <form class=\"form-horizontal\">\n                    <div class=\"form-group\">\n                        <label for=\"name_link\" class=\"col-xs-2 control-label\">Nombre</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"name_link\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"url\" class=\"col-xs-2 control-label\">Url</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"url\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"id_folder\" class=\"col-xs-2 control-label\">Carpeta</label>\n                        <div class=\"col-xs-8\">\n                            <select class=\"form-control\" id=\"id_folder\">\n                                <option value=\"0\"></option>\n                            </select>\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"description\" class=\"col-xs-2 control-label\">Descripci\xF2n</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"description\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"tags\" class=\"col-xs-2 control-label\">Tags</label>\n                        <div class=\"col-xs-8\">\n                            <div id=\"tags\" class=\"input textarea clearfix\"></div>\n                        </div>\n                    </div>\n                    <div\xA0class=\"form-group\">\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0<div\xA0class=\"col-xs-offset-5\xA0col-xs-4\">\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0<button\xA0id=\"bm-save\" type=\"button\"\xA0class=\"btn\xA0btn-default\">Agregar</button>\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0</div>\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0</div>\n                </form>\n            </div>\n        "], ["\n            <div>\n                <div class=\"alert alert-success hide\">\n                    Bookmark guardado!!!\n                </div>\n                <div class=\"alert alert-warning hide\">\n                Problemas al guardar el Bookmark :(\n                </div>\n                <form class=\"form-horizontal\">\n                    <div class=\"form-group\">\n                        <label for=\"name_link\" class=\"col-xs-2 control-label\">Nombre</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"name_link\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"url\" class=\"col-xs-2 control-label\">Url</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"url\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"id_folder\" class=\"col-xs-2 control-label\">Carpeta</label>\n                        <div class=\"col-xs-8\">\n                            <select class=\"form-control\" id=\"id_folder\">\n                                <option value=\"0\"></option>\n                            </select>\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"description\" class=\"col-xs-2 control-label\">Descripci\xF2n</label>\n                        <div class=\"col-xs-8\">\n                            <input type=\"text\" class=\"form-control\" id=\"description\">\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"tags\" class=\"col-xs-2 control-label\">Tags</label>\n                        <div class=\"col-xs-8\">\n                            <div id=\"tags\" class=\"input textarea clearfix\"></div>\n                        </div>\n                    </div>\n                    <div\xA0class=\"form-group\">\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0<div\xA0class=\"col-xs-offset-5\xA0col-xs-4\">\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0<button\xA0id=\"bm-save\" type=\"button\"\xA0class=\"btn\xA0btn-default\">Agregar</button>\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0</div>\n\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0</div>\n                </form>\n            </div>\n        "]);
...
},{"yo-yo":310}],316:[function(require,module,exports){
'use strict';
...
require('./errors/hideMessageStoreUser');

require('./errors/hideMessageLoginUser');

require('./success/hideMessageStoreUser');

},{"./errors/hideMessageLoginUser":316,"./errors/hideMessageStoreUser":317,"./success/hideMessageStoreUser":319}],319:[function(require,module,exports){
'use strict';
...
require('./backgroundSlider');

require('./hideMessages');

require('./forms/folder');

require('./forms/bookMark');

},{"./backgroundSlider":312,"./forms/bookMark":313,"./forms/folder":314,"./hideMessages":318,"babel-polyfill":1}],321:[function(require,module,exports){
"use strict";
...
var eventUtil = function () {
    ...
    _createClass(eventUtil, null, [{
        key: "addEventAction",
        value: function addEventAction(elementV) {
            var nameEventV = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "click";
            var listenerV = arguments[2];
